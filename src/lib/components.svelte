...
<div class="flex flex-col min-h-screen justify-center items-center my-[-4rem]">
    ...
    <!-- Tagline -->
    <div class="text-white text-5xl max-md:text-3xl font-['Oswald'] font-bold relative text-center">Capture your thoughts, Anytime, Anywhere</div> <br> 
    <div class="text-center w-1/2 text-white text-sm mx-4 font-light font-['Open Sans'] leading-4 max-md:w-3/4"> Write and edit your notes with a distraction-free interface, access your notes from any device, anywhere,  Scribble down thoughts, save your moments, pen epic tales, and uncover the mysteries of the universe (or just keep track of your grocery lists). </div><br>
