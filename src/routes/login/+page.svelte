...
<div class="mx-10 p-2 my-10">
        ...
        <input type="email" bind:value={email} placeholder=" enter email here" class="mb-2 border border-gray-200">
    </label>
    <br><br>
    <label for="password">
        Password<span class="text-red-700 text-sm">* </span>:
            <input type="password" bind:value={password} placeholder=" enter password here"class="mb-2 border border-gray-200">
    </label><br><br>
